...
export const EX_JSON = {
  ...
  abilities: {
    STR: { mod: 3, score: 17, save: 5 },
    DEX: { mod: 3, score: 16, save: 3 },
    CON: { mod: 2, score: 14, save: 4 },
    INT: { mod: 0, save: 0, score: 11 },
    WIS: { mod: 1, score: 13 },
    CHA: { score: 14, save: 2, mod: 2 },
  },
  skills: {
    ACROBATICS: 3,
    "SLEIGHT OF HAND": 3,
  ...
  weapons: [
    ...
    { name: "Mangual", bonus: "+5", damage: "1d8 Contundente" },
    { name: "Azagaias", bonus: "+5", damage: "1d6 Perfurante" },
    { name: "Ataque Desarmado", bonus: "+5", damage: "4 Concussão" },
  ],
  spellcasting: {
    ability: "Carisma",
    attackBonus: "+3",
